...
```
where **CUDA_ARCH=?** needs to match your GPU hardware, **Image_Size** is an integer (e.g., if you input 128, it means the image size is $128 \times 128$ pixels) and **Cell_Size** is in units of radians.
